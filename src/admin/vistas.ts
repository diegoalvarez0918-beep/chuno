...
export function vistaRegistro(entradas: readonly EntradaAuditoria[]): string {
  ...
  const legible: Record<string, string> = {
    ...
    foto_enviada: "Le mandó al cliente la foto del producto",
    foto_fallida: "No pudo mandar la foto del producto",
    tope_conversacion: "Frenó una conversación que se pasó del límite",
    tope_diario: "Se alcanzó el tope diario de consultas al modelo",
