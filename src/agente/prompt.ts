...
export function promptExtraccion(giro: Giro, negocio: ContextoNegocio): string {
  return [
    ...
    "   ANTES de decidir que algo no está, emparéjalo por SIGNIFICADO con el",
    "   catálogo, no por sus palabras exactas. El cliente nunca lo nombra igual:",
    "   «gafas progresivas» ES «Lentes progresivos», «un pastel» ES «Torta»,",
    "   «envío» ES «domicilio». Si se parece a algo de la lista, está en el",
    "   catálogo y necesitaHumano es false.",
