...
**Contexto del reto:** ver [`directives/00-contexto-reto-plug-nights.md`](directives/00-contexto-reto-plug-nights.md).
...
- **2026-07-27 — Andamiaje inicial:** El repo arrancó vacío; se creó la estructura de 3 capas (`directives/`, `execution/`, `.tmp/`) y se guardó el contexto del hackathon como directiva `00`. **Por qué importa:** el contexto del reto es la restricción dominante (48h, entregable = URL pública votable), y toda decisión técnica debe validarse contra los 5 criterios de evaluación antes de ejecutarse.
